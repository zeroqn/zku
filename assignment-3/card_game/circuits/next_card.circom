...
template NextCard() {
    ...
    cardNullifier === calculateCardNullifier.nullifier;
    ...
    cardCommitment === calculateCardCommitment.commitment;

    nullifier <== calculateCardNullifier.nullifier;
    commitment <== calculateCardCommitment.commitment;
}

component main {public [root, playerIndice, cardCommitment, cardNullifier]} = NextCard();
